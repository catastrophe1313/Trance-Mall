					...
					<div class="card border-0 mb-3 mt-3">
						<div class="card-body border d-flex justify-content-start">
							...
							<div class=" padding-bottom-2  ml-auto " id="btn1" style="padding:190px 0 0 0">
								<a href="http://localhost:8080/trance/dealbuy?text=境外旅游保险" class="btn btn-primary ml-3">立即投保</a>
							</div>
						</div>
						<br>
						<div class="card-body border d-flex justify-content-start">
							...
							<div class=" padding-bottom-2  ml-auto " id="btn1" style="padding:160px 0 0 0">
								<a href="http://localhost:8080/trance/dealbuy?text=探险驴友旅行保险" class="btn btn-primary ml-3">立即投保</a>
							</div>
						</div>
						...
						<div class="card-body border d-flex justify-content-start">
							...
							<div class=" padding-bottom-2  ml-auto " id="btn1" style="padding:190px 0 0 0">
								<a href="http://localhost:8080/trance/dealbuy?text=境内旅游保险" class="btn btn-primary ml-3">立即投保</a>
							</div>
						</div>
					</div>
